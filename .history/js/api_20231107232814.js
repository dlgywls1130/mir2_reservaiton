...
// 공유 URL API 호출
document.addEventListener("DOMContentLoaded", function() {
    const shareUrlInput = document.querySelector('.share_link_input input'); // 공유 URL 입력 필드
    const shareUrlButton = document.querySelector('.url_input_share'); // 공유 URL 제출 버튼
